...
export default function AdminMarks() {
  ...
  useEffect(() => {
    ...
    const studentsQuery = getStudentsInClass(selectedClass);
  ...
  async function handleCreateMark() {
    if (!user || !selectedStudent || !selectedSubject || !selectedClass) {
  ...
  return (
    <div className="space-y-4">
      <div className="card p-5">
        <div className="font-semibold mb-4">Manage Marks (Admin)</div>
      ...
      <div className="card p-5">
        ...
        {rows.length === 0 ? (
          <div className="text-neutral-500">No marks available. Select a class and student.</div>
        ) : (
